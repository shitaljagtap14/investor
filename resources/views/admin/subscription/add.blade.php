    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <div class="col-md-12">
                    <form method="POST" action="{{ url('subscription/add') }}" class="form-horizontal">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group hidden" id="custom-pkg">
                            ...
                            <input class="form-control" placeholder="Custom Package" name="custom_package" type="text"
                                   id="custom_package">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Subscription Amount" required
                                   name="subscription_amt" type="text" id="subscription_amt">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Status Level" required name="status_level"
                                   type="text" id="status_level">
                        </div>

                        <div class="form-group">
                            <label for="interest" class="control-label required">Interest<span class="required">*</span></label>
                            <input class="form-control" placeholder="Interest" required name="interest" type="text"
                                   id="interest">
                        </div>
